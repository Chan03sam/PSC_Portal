...
@Component({
  selector: 'app-cert-indigency',
  templateUrl: './cert-indigency.component.html',
  styleUrls: ['./cert-indigency.component.css']
})
export class CertIndigencyComponent {
  name: string = '';
  address: string = '';
  purpose: string = '';
  formType: string = '';
    ...
    this.authService.getCurrentUser()
      .then((user) => {
        ...
        const request = {
          ...
          status: 'pending',
          formType: 'Certificate of Indigency',
