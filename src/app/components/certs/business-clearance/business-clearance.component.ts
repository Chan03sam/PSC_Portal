...
@Component({
  selector: 'app-business-clearance',
  templateUrl: './business-clearance.component.html',
  styleUrls: ['./business-clearance.component.css']
})
export class BusinessClearanceComponent {
  name: string = '';
  business: string = '';
