...
@Component({
  selector: 'app-cert-goodmoral',
  templateUrl: './cert-goodmoral.component.html',
  styleUrls: ['./cert-goodmoral.component.css']
})
export class CertGoodmoralComponent {
  name: string = '';
  address: string = '';
  purpose: string = '';
  formType: string = '';
    ...
    this.authService.getCurrentUser()
      .then((user) => {
        ...
        const request = {
          ...
          status: 'pending',
          formType: 'Certificate of Good-Moral',
