...
@Component({
  selector: 'app-cert-guardianship',
  templateUrl: './cert-guardianship.component.html',
  styleUrls: ['./cert-guardianship.component.css']
})
export class CertGuardianshipComponent {
  name: string = '';
  address: string = '';
  childsname: string = '';
    ...
    this.authService.getCurrentUser()
      .then((user) => {
        ...
        const request = {
          ...
          childsbirthdate: this.childsbirthdate,
          childsage: this.childsage,
          status: 'pending',
          formType: 'Certificate of Guardianship',
