...
@Component({
  selector: 'app-cert-cohabitation',
  templateUrl: './cert-cohabitation.component.html',
  styleUrls: ['./cert-cohabitation.component.css']
})
export class CertCohabitationComponent {
  name: string = '';
  address: string = '';
  purpose: string = '';
  formType: string = '';
    ...
    this.authService.getCurrentUser()
      .then((user) => {
        ...
        const request = {
          ...
          partnersBirthdate: this.partnersBirthdate,
          spousesince: this.spousesince,
          status: 'pending',
          formType: 'Certificate of Cohabitation',
